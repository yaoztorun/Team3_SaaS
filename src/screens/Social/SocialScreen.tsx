...
import { SearchBar, Avatar } from '@/src/components/global';
                                        ...
                                        >
                                            <HStack space="md" className="items-center">
                                                <Avatar 
                                                    ...
                                                    fallbackText={userResult.full_name || userResult.email || '?'}
                                                    size={48}
                                                />
                                            ...
                                            >
                                                <HStack space="md" className="items-center">
                                                    <Avatar 
                                                        ...
                                                        fallbackText={request.sender_profile.full_name || '?'}
                                                        size={48}
                                                    />
                                                    <Box className="flex-1">
                                            ...
                                            >
                                                <HStack space="md" className="items-center">
                                                    <Avatar 
                                                        ...
                                                        fallbackText={friend.profile.full_name || '?'}
                                                        size={48}
                                                    />
                                                    <Box className="flex-1">
                                                        <Text className="text-base font-medium">
